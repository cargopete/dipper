//! `balerin get <query>`: search, choose, download. The whole point of the
...
use balerin_ia::{AdvancedQuery, IaClient, advanced};
...
pub async fn find(
    ...
    query: &str,
    limit: usize,
    local: Option<&balerin_index::Catalogue>,
...
pub async fn get_command(
    client: &IaClient,
    catalogue: Option<&balerin_index::Catalogue>,
    query: &str,
    limit: usize,
    choice: Choice,
