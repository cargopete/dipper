...
/// One result, in the shape the rest of balerin wants it.
...
pub struct Hit {
    ...
    /// Assembled locally from the infohash. A hit balerin cannot open is not a
