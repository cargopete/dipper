//! apibay's category codes, and the handful balerin offers.
//!
...
///
/// Video only, and deliberately so: balerin is a player, and offering a
...
/// 2xx is something balerin cannot play, and a 5xx row is something nobody
/// asked for.
