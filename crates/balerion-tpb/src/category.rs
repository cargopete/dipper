//! apibay's category codes, and the handful balerion offers.
//!
...
///
/// Video only, and deliberately so: balerion is a player, and offering a
...
/// 2xx is something balerion cannot play, and a 5xx row is something nobody
/// asked for.
