...
//! [`balerion_bt`], which is handed a magnet and never asked where it came from.
//!
//! ```no_run
//! # async fn demo() -> Result<(), balerion_tpb::Error> {
//! use balerion_tpb::{TpbClient, category, search};
//!
...
//! not a licence. balerion says so in the interface rather than in a comment
//! nobody reads.
