...
use balerin_tpb::{Hit, category, search};
...
pub struct SearchParams {
    ...
    /// [`balerin_tpb::category::Category::thin_cap`].
    #[serde(default)]
    pub thin: bool,
}
...
pub async fn handler(
    ...
    let usable: Vec<Hit> = found
        ...
        // it to things balerin cannot play.
...
mod tests {
    ...
    fn sized_hit(seeders: u64, category: u32, size_bytes: u64) -> Hit {
        Hit {
            ...
            added: 0,
            category,
            category_label: balerin_tpb::category::label(category),
